...
:: Privacy - Disable Internet Explorer Customer Experience Improvement Program.
...
:: Privacy - Disable Windows Messenger Customer Experience Improvement Program.
...
:: REVIEW ... some of these could break services like Google Drive / OneDrive
